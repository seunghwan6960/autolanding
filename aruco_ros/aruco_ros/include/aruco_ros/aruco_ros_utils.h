...
tf::Transform arucoMarker2Tf_for_Tracker(const aruco::MarkerPoseTracker &Tracker, bool check_tracker);
tf2::Transform arucoMarker2Tf2_for_Tracker(const aruco::MarkerPoseTracker &Tracker);
